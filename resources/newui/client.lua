...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if (IsPedInAnyVehicle(player, false)) then
            ...
            drawTxt(("%.3d"):format(math.ceil(speed)), 2, speedColor, 0.8, screenPosX, screenPosY + 0.000)
            ...
            drawTxt(("%.3d"):format(math.ceil(newFuel)), 2, fuelColor, 0.8, screenPosX + 0.050, screenPosY + 0.000)
