...
local bankMenu = true
local banks = {
  {name="Bank", id=108, colour=4, x=150.266, y=-1040.203, z=29.374},
  {name="Bank", id=108, colour=4, x=-1212.980, y=-330.841, z=37.787},
  {name="Bank", id=108, colour=4, x=-2962.582, y=482.627, z=15.703},
  {name="Bank", id=108, colour=4, x=-112.202, y=6469.295, z=31.626},
  {name="Bank", id=108, colour=4, x=314.187, y=-278.621, z=54.170},
  {name="Bank", id=108, colour=4, x=-351.534, y=-49.529, z=49.042},
  {name="Bank", id=108, colour=4, x=241.727, y=220.706, z=106.286},
  {name="Bank", id=108, colour=4, x=1175.0643310547, y=2706.6435546875, z=38.094036102295}
}	
...
local atms = {
  ...
  {name="ATM", id=277, x = -3241.05, y = 997.39, z = 12.55},
  {name="ATM", id=277, x = -3040.8, y = 593.03, z = 7.91},
  {name="ATM", id=277, x = 2683.12, y = 3286.58, z = 55.24},
  {name="ATM", id=277, x = 1377.49, y = 3625.35, z = 38.93},
  {name="ATM", id=277, x = 540.32, y = 2671.11, z = 42.16},
  {name="ATM", id=277, x = 380.83, y = 323.47, z = 103.57},
  {name="ATM", id=277, x = -56.91, y = -1752.17, z = 29.42},
  {name="ATM", id=277, x = 33.23, y = -1348.23, z = 29.5}
}
--================================================================================================
...
if bankMenu then
  ...
  while true do
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Press ~INPUT_PICKUP~ to access your Bank~b~")
