...
local Locations = {
    ...
    ["Markers"] = {
        ["FishingLocation1"] = { ["x"] = -1741.82, ["y"] = -1129.24, ["z"] = 12.17, ["Info"] = "[E] ~g~Fish" },
        ["FishingLocation2"] = { ["x"] = -1743.83, ["y"] = -1131.65, ["z"] = 12.17, ["Info"] = "[E] ~g~Fish" },
        ["FishingLocation3"] = { ["x"] = -1739.94, ["y"] = -1126.98, ["z"] = 12.17, ["Info"] = "[E] ~g~Fish" },
        ["SellFish"] = { ["x"] = -1845.28, ["y"] = -1195.79, ["z"] = 18.33, ["Info"] = "[E] ~g~Sell Fish" },
        ["BuyEquipment"] = { ["x"] = -1340.6, ["y"] = -1266.57, ["z"] = 4.05, ["Info"] = "[E] ~g~Buy Fishing Equipment" }
    }
}
    ...
    if hasRod and hasBait then
        Citizen.CreateThread(function()
            ...
            while Fishing do
                ...
                if FishOnBait then
                    ESX.Game.Utils.DrawText3D({ x = coords.x, y = coords.y, z = coords.z }, '[ENTER] Catch the Fish', 0.4)
        ...
        ESX.ShowNotification('Unfortunately you do not have enough fishing equipment!')
        return
    end
end
...
function OpenFishMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'fish_menu',
        {
            title    = 'Fishing Store',
            elements = {
				{label = 'Fishing Rod x 1 [100$]', item = 'fishingrod', price = 100, amount = 1},
				{label = 'Fish Bait x 1 [5$]', item = 'fishbait', price = 5, amount = 1},
				{label = 'Fish Bait x 25 [100$]', item = 'fishbait', price = 100, amount = 25},
            }
        },
        function(data, menu)
