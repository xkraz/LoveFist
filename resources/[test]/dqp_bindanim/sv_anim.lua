...
RegisterServerEvent("dqp:saveBind")
AddEventHandler("dqp:saveBind", function(anim,touche)
    ...
    MySQL.Async.fetchAll(
      ...
      function(result)
        ...
        if result[1] == nil then
          ...
          function (_)
            TriggerClientEvent("dqp:shownotif",_source,"Setting loaded",26)  
          end)
        else
          id = result[1].id
          ...
          function (_)
            TriggerClientEvent("dqp:shownotif",_source,"Setting loaded",26)  
            TriggerClientEvent("dqp:ready",_source)
      --      TriggerClientEvent("dqp:syncdemarche",_source,demarche)
          end)
        end
...
ESX.RegisterServerCallback('dqp:getsettings', function(source, cb)
