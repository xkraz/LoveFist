Locales['en'] = {
  ...
  ['roadcone']                  = 'roadcone',
  ['toolbox']                   = 'toolbox',
  ['marducas_stock']            = 'marducas Stock',
  ['quantity']                  = 'quantity',
  ['invalid_quantity']          = 'invalid quantity',
  ['inventory']                 = 'inventory',
  ['veh_unlocked']              = '~g~Vehicle Unlocked',
  ['hijack_failed']             = '~r~Hijack Failed',
  ['repair_failed']             = '~r~Repair Failed',
  ['body_repaired']             = '~g~Body repaired',
  ['full_repaired']             = '~g~Vehicle repaired',
  ['veh_repaired']              = '~g~Engine Repaired Fully',
  ['med_repaired']              = '~y~Engine Repaired Partly',
  ['bad_repaired']              = '~r~You were just able to get it started, see a mechanic ASAP!',
  ...
  ['marducas_customer']         = 'marducas Customer',
  ...
  ['too_high']                  = '~r~Not damaged enough',
  ['half_way']                  = 'Almost done!',
}
