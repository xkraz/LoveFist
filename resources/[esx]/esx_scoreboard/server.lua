...
AddEventHandler('esx:setJob', function(playerId, job, jobgrade, lastJob)
	connectedPlayers[playerId].job = job.name
	connectedPlayers[playerId].jobLabel = job.label
	connectedPlayers[playerId].jobgrade = job.grade_name
	connectedPlayers[playerId].jobgradeLabel = job.grade_label
...
function AddPlayerToScoreboard(xPlayer, update)
	...
	connectedPlayers[playerId].jobgrade = xPlayer.job.grade_name
	connectedPlayers[playerId].jobgradeLabel = xPlayer.job.grade_label
