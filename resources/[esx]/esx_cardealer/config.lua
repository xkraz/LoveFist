...
Config.AuthorizedVehicles = {
	...
	recruit = {
		{ model = 'cardealer7', label = 'Recruit Cruiser', price = 0 },

	},
	
	officer = {
		{ model = 'cardealer', label = 'Cardealer Cruiser', price = 0 },
		{ model = 'cardealer4', label = 'Cardealer Cruiser 2', price = 0 },
		{ model = 'cardealerb', label = 'Cardealer Bike', price = 0 },

},
	
	officertwo = {
		{ model = 'cardealer', label = 'Cardealer Cruiser', price = 0 },
		{ model = 'cardealer2', label = 'Cardealer Charger', price = 0 },
		{ model = 'cardealer4', label = 'Cardealer Cruiser 2', price = 0 },
		{ model = 'cardealerb', label = 'Cardealer Bike', price = 0 },
	...
	airunit = {
			{ model = 'cardealer', label = 'Cardealer Cruiser', price = 0 },
		{ model = 'cardealer2', label = 'Cardealer Charger', price = 0 },
		{ model = 'cardealer3', label = 'Cardealer Explorer', price = 0 },
		{ model = 'cardealer4', label = 'Cardealer Cruiser 2', price = 0 },
		{ model = 'cardealer6', label = 'Cardealer K9 GMC', price = 0 },
		{ model = 'cardealer7', label = 'Cardealer Cadet', price = 0 },
		{ model = 'cardealerb', label = 'Cardealer Bike', price = 0 },
		{ model = 'cardealert', label = 'Cardealer Transporter', price = 0 },
		{ model = '2015polstang', label = 'Cardealer Stang', price = 0 },
		{ model = 'pcpdvig', label = 'Cardealer rod', price = 0 },
		{ model = 'pbus', label = 'Cardealer Prison Bus', price = 0 },
...
Config.AuthorizedHelicopters = {
	...
	airunit = {
		{ model = 'polmav', label = 'Cardealer Maverick', livery = 0, price = 0 }
	},
