Locales['fr'] = {
  ...
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~Cardealer~s~',
  -- Vehicle interaction
  ...
  ['cardealer_stock'] = 'stock Cardealer',
  -- Misc
  ...
  -- Notifications
  ['alert_cardealer'] = 'alerte cardealer',
