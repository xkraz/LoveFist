Locales['en'] = {
  ...
  ['cardealer_wear'] = 'cardealer Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~Cardealer~s~',
  -- Vehicle interaction
