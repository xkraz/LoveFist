	...
	while true do
		...
		if fishing then
			...
			if fishing then
				...
				if pos.y >= 7700 or pos.y <= -4000 or pos.x <= -3400 or pos.x >= 4300 or IsPedInAnyVehicle(GetPlayerPed(-1)) then
...
function OpenBoatsMenu(x, y , z)
	...
	local elements = {}
		...
		table.insert(elements, {label = '<span style="color:green;">Suntrap</span> <span style="color:red;">20$</span>', value = 'boat6'}) 
		table.insert(elements, {label = '<span style="color:green;">Jetmax</span> <span style="color:red;">30$</span>', value = 'boat5'}) 	
		table.insert(elements, {label = '<span style="color:green;">Toro</span> <span style="color:red;">40$</span>', value = 'boat2'}) 
		table.insert(elements, {label = '<span style="color:green;">Marquis</span> <span style="color:red;">50$</span>', value = 'boat3'}) 
		table.insert(elements, {label = '<span style="color:green;">Tug boat</span> <span style="color:red;">60$</span>', value = 'boat4'})
	...
	if data.current.value == 'boat' then
		...
		TriggerServerEvent("fishing:lowmoney", 10) 
		TriggerEvent("chatMessage", 'You rented a boat for', {255,0,255}, '$' .. 10)
	...
	if data.current.value == 'boat2' then
		...
		TriggerEvent("chatMessage", 'You rented a boat for', {255,0,255}, '$' .. 20)
		SetPedCoordsKeepVehicle(ped, x, y , z)
	...
	if data.current.value == 'boat3' then
		...
		TriggerServerEvent("fishing:lowmoney", 30) 
		TriggerEvent("chatMessage", 'You rented a boat for', {255,0,255}, '$' .. 30)
		SetPedCoordsKeepVehicle(ped, x, y , z)
	...
	if data.current.value == 'boat4' then
		...
		TriggerEvent("chatMessage", 'You rented a boat for', {255,0,255}, '$' .. 40)
		SetPedCoordsKeepVehicle(ped, x, y , z)
	...
	if data.current.value == 'boat5' then
		...
		TriggerServerEvent("fishing:lowmoney", 50) 
		TriggerEvent("chatMessage", 'You rented a boat for', {255,0,255}, '$' .. 50)
		SetPedCoordsKeepVehicle(ped, x, y , z)
	...
	if data.current.value == 'boat6' then
		...
		TriggerEvent("chatMessage", 'You rented a boat for', {255,0,255}, '$' .. 60)
		SetPedCoordsKeepVehicle(ped, x, y , z)
