...
Config.Zones = {
    ...
    Bar = {
        Items = {bread, beer, wine, vodka, tequila, whisky, gintonic, absinthe ,champagne, cigarett, lighter},
        Pos = {
            {x = 127.830,   y = -1284.796, z = 28.280}, --StripClub
            {x = -1393.409, y = -606.624,  z = 29.319}, --Bahamamas
            {x = -559.906,  y = 287.093,   z = 81.176}, --Tequila la
		{x = 953.62,  y = 69.84,   z = 2.47}, --CASINO
    ...
    Casino = {
        Items = {casino_chip},
        Pos = {
            {x = 968.54, y = 36.75,  z = 2.30}, --Casino
        }
    },
