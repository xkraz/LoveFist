...
function OpenHandCuffMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions2',
	{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'fine', {
				...
				if amount == nil or amount < 0 or amount > 200000 then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						menu.close()
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_police', _U('fine'), amount)
					end
				end
			end, function(data, menu)
				menu.close()
	...
	ESX.TriggerServerCallback('esx_policejob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category',
		{
			...
			if Config.EnablePlayerManagement then
				...
				---JINKS ADD calls to new server event in server/main.lua (esx_policejob:FinePaperwork)
				TriggerServerEvent('esx_policejob:FinePaperwork', GetPlayerServerId(player), fid, amount)
				--ESX.TriggerServerCallback('esx_policejob:FinePaperwork', function( '2', '3', '4')
			else
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, Keys['G']) and not isDead  and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'police_actions2') then
			if Config.MaxInService == -1 then
