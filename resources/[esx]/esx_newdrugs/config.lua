...
Config.MultiPlant	= true -- Will give up to three of each product when a plant is picked
...
Config.Delays = {
	...
	CocaineProcessing = 1000 * 10,
	EphedrineProcessing = 1000 * 10,
	MethProcessing = 1000 * 10,
	PoppyProcessing = 1000 * 10,
	CrackProcessing = 1000 * 10,
...
Config.ProcessZones = {
	...
	MethProcessing = {coords = vector3(2433.96, 4968.87, 42.35), name = 'Liquor Ace', color = 25, sprite = 93, radius = 1.0},
	...
	HeroineProcessing = {coords = vector3(1347.35, 4389.81, 44.34), name = 'Dirty Garage', color = 59, sprite = 388, radius = 1.0},
}

Config.DumpZones = {
	WeedDump = {coords = vector3(-1172.02, -1571.98, 4.66), name = 'Smoke On The Water', color = 25, sprite = 140, radius = 1}, --coords = vector3(-1172.02, -1571.98, 4.66), name = 'Smoke On The Water', color = 25, sprite = 140, radius = 1
	CocaineDump = {coords = vector3(-1366.66, 56.67, 54.1), name = 'Golf Club', color = 62, sprite = 109, radius = 1.0}, --coords = vector3(-1366.66, 56.67, 54.1), name = 'Golf Club', color = 62, sprite = 109, radius = 1.0
	MethDump = {coords = vector3(-56.31, 6521.97, 31.49), name = 'Charle\'s Pharmacy', color = 49, sprite = 403, radius = 1.0}, --coords = vector3(-56.31, 6521.97, 31.49), name = 'Charle\'s Pharmacy', color = 49, sprite = 403, radius = 1.0
	HeroineDump = {coords = vector3(-431.3, -2442.74, 26.88), name = 'Frederick\'s Crane', color = 25, sprite = 68, radius = 1.0}, --coords = vector3(-431.3, -2442.74, 26.88), name = 'Frederick\'s Crane', color = 25, sprite = 68, radius = 1.0
	OpiumDump = {coords = vector3(2454.94, 4980.58, 46.82), name = 'O\'Neil Farm', color = 59, sprite = 387, radius = 1.0}, --coords = vector3(2454.94, 4980.58, 46.82), name = 'O\'Neil Farm', color = 59, sprite = 387, radius = 1.0
	CrackDump = {coords = vector3(-4.88, -1227.61, 29.3), name = 'Homeless Hostel', color = 49, sprite = 456, radius = 1.0}, --coords = vector3(-4.88, -1227.61, 29.3), name = 'Homeless Hostel', color = 49, sprite = 456, radius = 1.0
}
...
Config.Peds = {
	...
	MethProcess =		{ ped = 516505552, x = 2432.3,	y = 4970.7,	z = 41.35,	h = 120.83 },
