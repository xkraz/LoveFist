  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cloakroom',
    {
      ...
      elements = {
        ...
        {label = _U('courthouse_wear'), value = 'courthouse_wear'},
      },
    },
    function(data, menu)
      ...
      if data.current.value == 'citizen_wear' then
        ...
        TriggerServerEvent("player:serviceOff", "courthouse")
          local model = nil
      ...
      if data.current.value == 'courthouse_wear' then
            ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
              TriggerServerEvent("player:serviceOn", "courthouse")
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  local vehicles = Config.CourthouseStations[station].Vehicles
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_courthouse:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_courthouse:removeVehicleFromGarage', 'courthouse', vehicleProps)
    ...
    table.insert(elements, { label = 'Voiture de fonction', value = 'surge' })
...
function OpencourthouseActionsMenu()
	
	ESX.UI.Menu.CloseAll()

	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'courthouse_actions',
		{
			title    = 'Avocat',
			align    = 'top',
			elements = {
					...
					function(data, menu)
						...
						if amount == nil then
							...
							if closestPlayer == -1 or closestDistance > 3.0 then
								...
								TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_courthouse', 'courthouse', amount)
							end
						end
					end,
				function(data, menu)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_courthouse:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_courthouse:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_courthouse:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_courthouse:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_courthouse:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_courthouse:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'courthouse' then
      ...
      for k,v in pairs(Config.CourthouseStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'courthouse' and (PlayerData.job.grade_name == 'boss' or 'bossthree') then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'courthouse' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_courthouse:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_courthouse:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
...
AddEventHandler('esx_courthousejob:hasExitedEntityZone', function(entity)
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'courthouse' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_courthouse:putVehicleInGarage', 'courthouse', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'courthouse') 
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:openBossMenu', 'courthouse', function(data, menu)
    ...
    if IsControlPressed(0,  Keys['F6']) and Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'courthouse' and (GetGameTimer() - GUI.Time) > 150 then
		OpencourthouseActionsMenu()
		GUI.Time = GetGameTimer()
	end
  end
end)
