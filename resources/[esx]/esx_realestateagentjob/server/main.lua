...
AddEventHandler('esx_realestateagentjob:rent', function(target, property, price)
	local xPlayer, xTarget = ESX.GetPlayerFromId(source), ESX.GetPlayerFromId(target)
		...
		TriggerEvent('esx_property:removeOwnedProperty', property, price, xTarget.identifier)
end)


RegisterServerEvent('esx_realestateagentjob:rent2')
AddEventHandler('esx_realestateagentjob:rent2', function(target, property)
	local xPlayer = ESX.GetPlayerFromId(target)

	TriggerEvent('esx_property:removeOwnedProperty', property, price, xPlayer.identifier)
end)
