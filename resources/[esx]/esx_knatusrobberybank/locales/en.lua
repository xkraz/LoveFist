Locales['en'] = {
	...
	['robbery_successful'] = 'Successful heist, you recived ~g~$',
	...
	['press_to_bomb'] = 'Press ~INPUT_CONTEXT~ to plant the Bomb on the door! ~b~',
	['robbery_of'] = 'Bank robbery: ~r~',
	['bomb_of'] = 'Planted bomb: ~r~',
	['hack_of'] = 'hacking the bank: ~r~',
	['seconds_remaining'] = '~w~ seconds left',
	['robbery_cancelled_at'] = '~r~ Robbery canceled at: ~b~',
	['robbery_has_cancelled'] = '~r~ The robbery has been canceled: ~b~',
	['already_robbed'] = 'This site has already been robbed. Please wait: ',
	['seconds'] = ' seconds.',
	['minutes'] = ' minutes, ',
	['hours'] = ' hours, ',
	...
	['hold_pos_plantbomb'] = 'Hold on while you Plant the bomb, you re almost inside!',
	['leave'] = 'Press ~INPUT_CONTEXT~ to exit ',
	['robbery_complete'] = '~g~Completed robbery.~s~ ~h~ Your take: ~y~$',
	['hack_complete'] = '~r~ Hacked completed. Now Complete the mission! ',
