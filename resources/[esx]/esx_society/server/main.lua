...
function isPlayerBoss(playerId, job)
	...
	if xPlayer.job.name == job and (xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'bosstwo' or xPlayer.job.grade_name == 'bossthree' or xPlayer.job.grade_name == 'recruiter')then
		return true
	else
