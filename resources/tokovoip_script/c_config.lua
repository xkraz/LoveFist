TokoVoipConfig = {
	...
	distance = {
		...
		100, -- Shout speech distance in gta distance units (Might make megaphone)
	},
	...
	plugin_data = {
		...
		TSChannelWait = "TOKOVOIP",
		
		-- Blocking screen informations
		TSServer = "142.4.218.25", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "WaitingSupport", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "https://lfrpgta.com/", -- Download link displayed on blocking screen
