...
function FindNearestFuelPump()
	...
	repeat
		if Config.PumpModels2[GetEntityModel(object)] then
...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				DrawAdvancedText(0.2663 - x, 0.973 - y, 0.039, 0.0028, 0.5, fuel, 0, 255, 0, 255, 6, 1)
				DrawAdvancedText(0.2663 - x, 0.973 - y, 0.019, 0.0028, 0.5, "Fuel", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
		end
