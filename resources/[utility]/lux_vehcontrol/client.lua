...
CONTROLS
	...
	---------------------------------------------------
State of Emergency Controls: Edited by TheKodah
	CONTROLS
		Right indicator (Lines 569-620): Commented Out
		Left indicator (Lines 569-620): Commented Out
		Hazard lights (Lines 569-620): Commented Out
		Toggle emergency lights (Line 453):	E
		Airhorn (Line 514): LeftShift
		Toggle siren (Line 463): G
		Manual siren/Change siren tone (Line 494):	Y
		Auxiliary siren (Line 478): =
	---------------------------------------------------
]]
			...
			if IsPedInAnyVehicle(playerped, false) then
				...
				if GetPedInVehicleSeat(veh, -1) == playerped then
					...
					if GetVehicleClass(veh) == 18 then
						...
						--DisableControlAction(0, 172, true) -- INPUT_CELLPHONE_UP was 172
