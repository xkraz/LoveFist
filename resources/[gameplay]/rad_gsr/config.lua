...
Config.waterCleanTime           = 30 * 1000         -- Change first number only, Set time in water needed to clean off GSR (default: 30 sec). Was set at 120
...
Config.gsrAutoRemove            = 20 * 60 * 1000    -- Change first number only, to set the auto clean up in minuets (default: 10 min).
