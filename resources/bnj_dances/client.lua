...
mainMenu = NativeUI.CreateMenu("Dance Menu", "~b~Dance in Style..")
...
Citizen.CreateThread(function()
    while true do
      Citizen.Wait(0)
          ...
          if IsControlJustPressed(1, 313) then -- Si se presiona F10
              abrirMenu()
          end 
    end
end) 
...
local submenu = _menuPool:AddSubMenu(menu, "Dances with Intensity »", "[E or Q] Intensity   [Arrows] Brazos   [SHIFT] Change Dance  [X] Cancel")
local opcion1 = NativeUI.CreateItem("Man", "Male Dances")
local opcion2 = NativeUI.CreateItem("Female", "Female Dances")
local opcion3 = NativeUI.CreateItem("Junkie", "Junkie Dances")
...
function DJ(menu)
local submenu2 = _menuPool:AddSubMenu(menu, "DJ Dances »", "DJ Mixing Dances")
local opcion1 = NativeUI.CreateItem("Mixing Concentrate", "You are focused on the machine, but moving your feet to the rhythm of the music")
local opcion2 = NativeUI.CreateItem("Take a Rest", "You mix, you take off your headphones, and you dance a little ")
local opcion3 = NativeUI.CreateItem("Mix and Relax", "You stop mixing a little, and take a sip from a back glass")
local opcion4 = NativeUI.CreateItem("Put on Headphones", "You put on your headphones and raise your hands")
local opcion5 = NativeUI.CreateItem("Mix and Dance", "You're mixing and you start dancing a little")
local opcion6 = NativeUI.CreateItem("Mix and Party", "Mixes and claps to the rhythm of the music")
local opcion7 = NativeUI.CreateItem("Motivated Mixing", "You are focused and motivated by mixing the music")
...
local submenu3 = _menuPool:AddSubMenu(menu, "Animations »", "Different New Expressions.")
local opcion1 = NativeUI.CreateItem("Shit", "You sigh when you lose something ..")
local opcion2 = NativeUI.CreateItem("Hell Yeah!", "You won on something, and you celebrate it")
local opcion3 = NativeUI.CreateItem("DJ1", "1")
local opcion4 = NativeUI.CreateItem("Huge!", "You indicate something with your arms, that big ..")
local opcion5 = NativeUI.CreateItem("Hey, Come here Buddy", "You raise your arms calling a friend, come and say hello")
