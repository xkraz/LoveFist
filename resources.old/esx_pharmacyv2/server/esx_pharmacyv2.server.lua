...
RegisterServerEvent('esx_pharmacyv2:buyItem')
AddEventHandler('esx_pharmacyv2:buyItem', function(itemName, price)
...
RegisterServerEvent('esx_pharmacyv2:removeItem')
AddEventHandler('esx_pharmacyv2:removeItem', function(itemName)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)
...
ESX.RegisterUsableItem('firstaidkit', function(source)
  ...
  if not hasAmbulance then
    TriggerClientEvent('esx_pharmacyv2:useKit', source, 'firstaidkit', 4)
  else
...
ESX.RegisterUsableItem('defibrillateur', function(source)
  ...
  if not hasAmbulance then
    TriggerClientEvent('esx_pharmacyv2:useDefibrillateur', source, 'defibrillateur')
  else
    TriggerClientEvent('esx:showNotification', source, _U('has_ambulance'))  
  end
end)
...
TriggerClientEvent('esx_pharmacyv2:frisk', source)
TriggerClientEvent('esx_basicneeds:onDrinkCoffee', source)
TriggerClientEvent('esx:showNotification', source, _U('used_anti'))
end)