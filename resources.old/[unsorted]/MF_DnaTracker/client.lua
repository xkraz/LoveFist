...
AddEventHandler('MF_DnaTracker:AnalyzeDNA', function()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), "Blood_Info", { title = "DNA Analyzer", align = 'left', elements = elements }, 
    function(data,menu)
      menu.close()
...
AddEventHandler('MF_DnaTracker:AnalyzeAmmo', function()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), "AnalyzeAmmo", { title = "Ammo Analyzer", align = 'left', elements = elements }, 
    function(data,menu)
      menu.close()
      ESX.UI.Menu.CloseAll()          
    end,    
