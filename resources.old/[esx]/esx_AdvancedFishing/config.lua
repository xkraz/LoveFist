Config = {}
	...
	Config.FishPrice = {a = 10, b = 12} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 3, b = 4} --Will get dirty money
	Config.SharkPrice = {a = 5, b = 6} --Will get dirty money
