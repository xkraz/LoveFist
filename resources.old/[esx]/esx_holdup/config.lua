...
Stores = {
	["paleto_twentyfourseven"] = {
		...
		reward = math.random(400, 1100),
		nameOfStore = "24/7. (Paleto Bay)",
		secondsRemaining = math.random(180, 240), -- seconds
		lastRobbed = 0
	},
	["sandyshores_twentyfoursever"] = {
		...
		secondsRemaining = math.random(90, 150), -- seconds
		lastRobbed = 0
	},
	["littleseoul_twentyfourseven"] = {
		position = { x = -709.17, y = -904.21, z = 19.21 },
		reward = math.random(500, 1200),
	...
	["bar_one"] = {
		...
		secondsRemaining = math.random(110, 180), -- seconds
		lastRobbed = 0
	},
	["ocean_liquor"] = {
