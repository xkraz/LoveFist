			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 400, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 3,
					requires = "copper",
			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 300, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 6,
					requires = "iron",
